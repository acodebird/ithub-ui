    ...
    <a-col :span="20">
      <div class="msg_box">
          ...
          <a-row class="msg" v-for="msg in messages" :key="msg.id">
            <a-row>
              <a-col :span="18" class="msg_title" v-if="msg.state == 0"><a-icon type="sound" style="color: red;" />&nbsp;<b>{{msg.operator}}</b>评论了你的文章</a-col>
              <a-col :span="18" class="msg_title" v-else><a-icon type="sound"/>&nbsp;<b>{{msg.operator}}</b>评论了你的文章</a-col>
